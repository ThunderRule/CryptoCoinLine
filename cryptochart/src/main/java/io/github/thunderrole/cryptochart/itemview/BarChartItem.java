...
public class BarChartItem extends BaseChartItem {
    ...
    protected void onDraw(Canvas canvas) {
        ...
        if (mLinkChartEntry != null) {
            realHeight = height - entry.getValue() * mScale - UIUtils.dp2px(getContext(), 30f) - 40;
        }
        //TODO 柱子间隔缩放
        canvas.drawRect(5*mFingerScale, realHeight, width - 5*mFingerScale, height, mPaint);
